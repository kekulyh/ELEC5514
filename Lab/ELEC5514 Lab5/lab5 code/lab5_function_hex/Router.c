            ...
            case APSDE_DATA_indication:
                {
                    ...
                    switch (params.APSDE_DATA_indication.DstEndpoint)
                    {
						...
						case 172:	
							...
							char received_data1 =APLGet(); //APLGet() function will return the
							char received_data2 =APLGet();     // data in payload one by one.
      						char received_data3 =APLGet();
							char sending_data1 = 0;
							char sending_data2 = 0;
							char sending_data3 = 0;
					        ...
					        {	
								...
								int count_1_new = 0;
								case 0x1111:
									num1 = received_data1 - '0';
									num2 = received_data2 - '0';
									num3 = received_data3 - '0';
									decimal = num1 * 100 + num2 * 10 + num3 * 1;
									
									for (count_1_new = 3; count_1_new>0; count_1_new-- )
									{
									...
									sending_data1 = hexStr[0];
									sending_data2 = hexStr[1];
									sending_data3 = hexStr[2];
									
									break;
							}
      						/* you may also want to send some data back*/
							TxBuffer[TxData++]   = sending_data1;    //writ the data you want to send back into 
							TxBuffer[TxData++]   = sending_data2;    // the buffer, if there is any
							TxBuffer[TxData++]   = sending_data3;    
